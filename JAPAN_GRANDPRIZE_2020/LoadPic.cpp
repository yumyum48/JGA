...
int LoadPicture() {
	...
	if ((g_pic.player[3] = LoadGraph("image/4.png")) == -1) return -1;
	if ((g_pic.player[4] = LoadGraph("image/3.png")) == -1) return -1;
	if ((g_pic.player[5] = LoadGraph("image/2.png")) == -1) return -1;
	if ((g_pic.player[6] = LoadGraph("image/1.png")) == -1) return -1;
	if ((g_pic.player[7] = LoadGraph("image/2.png")) == -1) return -1;
